...
function loadedComments(){
	$.ajax({
	    url: '/includes/json/comments?q='+urlParam('product_id')+'&timeago=true',
	    dataType: 'json',
	    type: 'GET',
...
$(document).ready(function(){
	$('#product_comemnts').append('<br /><img class="pb-center-image" src="/images/interior-images/innerlaced-loader.gif" />');
	...
	$('body').on('click', '[name="add_comment"]', function(event){
		...
		$.ajax({
		  ...
		  data: "comment="+comment+'&post_id='+urlParam('product_id'),
